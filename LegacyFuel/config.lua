...
Config.Strings = {
	ExitVehicle = "Get your ass out to refuel",
	EToRefuel = "Press ~r~E ~w~to refuel vehicle",
	JerryCanEmpty = "Fill it Stupid",
	FullTank = "Tank is full",
	PurchaseJerryCan = "Press ~r~E ~w~to purchase a jerry can for ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Press ~r~E ~w~to cancel the fueling",
	CancelFuelingJerryCan = "Press ~r~E ~w~to cancel the fueling",
	NotEnoughCash = "~g~YOU ~r~BROKE ~g~ASS ~r~BITCH",
	RefillJerryCan = "Press ~r~E ~w~ to refill the jerry can for ",
	NotEnoughCashJerryCan = "~g~YOU ~r~BROKE ~g~ASS ~r~BITCH",
	JerryCanFull = "Jerry can is full DUMB ASS!!",
	TotalCost = "Cost",
}
